...
class PitWallTop3DriversWidget : GlanceAppWidget() {
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        val title = context.getString(R.string.driver_championship)

        val top3 = listOf(
            prefs.getString(WidgetConstants.KEY_DRIVER1_NAME, "-") to prefs.getInt(WidgetConstants.KEY_DRIVER1_POINTS, 0),
            prefs.getString(WidgetConstants.KEY_DRIVER2_NAME, "-") to prefs.getInt(WidgetConstants.KEY_DRIVER2_POINTS, 0),
            prefs.getString(WidgetConstants.KEY_DRIVER3_NAME, "-") to prefs.getInt(WidgetConstants.KEY_DRIVER3_POINTS, 0)
        )
